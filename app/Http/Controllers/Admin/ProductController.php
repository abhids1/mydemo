...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.products.index',compact('breadCrumb'));
    } 
   ...
   public function getProducts(Request $request){
    ...
    foreach($records as $record){
       ...
       $data_arr[] = array(
         ...
         "amount" => $amount,
         "stock" => $stock,
         "action" => '<a href="javascript:;" type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-default" data-remote="products/view_details/'.$id.'">Launch Default Modal
       </a>'
       );
    }   
    ...
    public function index_yajra(Request $request)
    {
        ...
        return view('admin.products.index_yajra');
    }
    
    public function view_details($id=null){
        $data = Product::find($id);
        return view('admin.products.view_details', ['data' => $data])->render();
